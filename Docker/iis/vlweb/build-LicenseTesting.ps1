...
try {
    ...
    docker image build --build-arg BASE_TAG=$BASE_TAG $ClearCacheCmd $HypervCmd --tag lansalpc/iis/licensetesting:$WINDOWS_VERSION-$ImageVersion -f LicenseTesting.dockerfile .
