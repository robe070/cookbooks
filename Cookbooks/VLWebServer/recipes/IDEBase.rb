...
features = %w{IIS-WebServerRole IIS-WebServer IIS-CommonHttpFeatures IIS-DefaultDocument IIS-DirectoryBrowsing IIS-HttpErrors IIS-StaticContent IIS-ApplicationDevelopment IIS-NetFxExtensibility45 IIS-ASPNET45 IIS-CGI IIS-ISAPIExtensions IIS-ISAPIFilter IIS-HealthAndDiagnostics IIS-HttpLogging IIS-RequestMonitor IIS-Security IIS-RequestFiltering IIS-Performance IIS-HttpCompressionStatic IIS-WebServerManagementTools IIS-ManagementConsole WAS-WindowsActivationService WAS-ProcessModel WAS-NetFxEnvironment WAS-ConfigurationAPI}
