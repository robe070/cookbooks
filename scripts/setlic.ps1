...
Import-PfxCertificate –FilePath c:\\packerTemp\\LansaScalableLicense.pfx cert:\\localMachine\\my -Password $mypwd
...
Get-Process | Out-File c:\\packerTemp\\LansaScalableLicense.pfx
#Now delete it from Explorer
Remove-Item c:\\packerTemp\\LansaScalableLicense.pfx
